        ...
        <div>
            ...
            <div className="container">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <DropdownFilter title="Salary Estimate" list={date_posted} />
                    <DropdownFilter title="Job Type" list={date_posted} />
            ...
            <div className="container">
                <div className="row">
                    ...
                    {(currentDepartment == "" || currentDepartment == "All departments") ? (
                        <h6>Showing 1100 Jobs for All departments</h6>
                    ) : (
                        <h6>Showing 1100 Jobs for {currentDepartment} department</h6>
                    )}
                    {/* Top Section of Jobs page */}
                    <br />

                    <p>Jobs in lahore</p>

                    <p className="d-flex justify-content-end">Page 1 of 5,958 jobs &nbsp;&nbsp; <i className="far fa-question-circle mt-1"></i></p>
